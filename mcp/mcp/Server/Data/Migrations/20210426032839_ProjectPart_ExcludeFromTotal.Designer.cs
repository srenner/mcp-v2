...
namespace mcp.Server.Data.Migrations
{
    ...
    [Migration("20210426032839_ProjectPart_ExcludeFromTotal")]
    partial class ProjectPart_ExcludeFromTotal
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("mcp.Server.Models.ProjectChecklistItem", b =>
                {
                    b.Property<int>("ProjectChecklistItemID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("ProjectChecklistItemID");

                    b.HasIndex("ProjectID");

                    b.ToTable("ProjectChecklistItem");
                });
            ...
            modelBuilder.Entity("mcp.Server.Models.ProjectStatus", b =>
                {
                    b.Property<int>("ProjectStatusID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("mcp.Server.Models.ProjectTool", b =>
                {
            ...
            modelBuilder.Entity("mcp.Server.Models.Tag", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            TagID = 8,
                            Description = "A vehicle built for drift events",
                            IsDeleted = false,
                            Name = "Drift",
                            SortOrder = 0
                        },
            ...
            modelBuilder.Entity("mcp.Server.Models.Project", b =>
                {
                    b.HasOne("mcp.Server.Models.Project", "ParentProject")
                        .WithMany("SubProjects")
                        .HasForeignKey("ParentProjectID");

                    b.HasOne("mcp.Server.Models.ProjectStatus", "ProjectStatus")
                        .WithMany()
